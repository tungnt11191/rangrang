odoo.define('l10n_vn_pos.pos', function (require) {
"use strict";
...
models.Order = models.Order.extend({
    export_for_printing: function() {
      ...
      if (this.pos.company.country.code === 'VN') {
          const codeWriter = new window.ZXing.BrowserQRCodeSvgWriter()
          let qr_values = this.compute_vn_qr_code(result.company.name, result.company.vat, result.date.isostring, result.total_with_tax, result.total_tax);
    ...
    compute_vn_qr_code(name, vat, date_isostring, amount_total, amount_tax) {
